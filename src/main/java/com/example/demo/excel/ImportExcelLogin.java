...
public class ImportExcelLogin {
	public static String TYPE = "text/csv";
	static String[] HEADERs = { "Id", "Name", "Password", "Email", "Gender", "Image" };
	...
	public static List<Login> csvToTutorials(InputStream is) {
		...
		try (BufferedReader fileReader = new BufferedReader(new InputStreamReader(is, "UTF-8"));
			...
			for (CSVRecord csvRecord : csvRecords) {
				Login productTutorial = new Login(Long.parseLong(csvRecord.get("Id")), csvRecord.get("Name"),
						csvRecord.get("Password"), csvRecord.get("Email"), csvRecord.get("Gender"),
						csvRecord.get("Image")
	...
	public static ByteArrayInputStream tutorialsToCSV(List<Login> laptopList) {
		...
		try (ByteArrayOutputStream out = new ByteArrayOutputStream();
			...
			// chuỗi
			for (Login productTutorial : laptopList) {
				List<Object> data = Arrays.asList(String.valueOf(productTutorial.getUserId()),
						productTutorial.getUsername(), productTutorial.getPassword(), productTutorial.getEmail(),
						productTutorial.getGender(), productTutorial.getImage()
